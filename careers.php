<?php 
$pageTitle="Careers:";
$pageSummary="ParkWood Document Solutions are building something special and we are looking for motivated people to join our Sales Team";
$metaKeywords = "Photocopiers,Photocopier Sales,Copier Sales,Copiers,Printers,Printer Sales,Job Opportunities,Careers,Sales Team,Hampshire,Dorset,Wiltshire,Egland,UK";
$metaDescription = "ParkWood Document Solutions are building something special and we are looking for motivated people to join our Sales Team";
include('include/pds-main.php');
include('include/pds-header.php');
?>
<div id="crumbs-wrapper">
	<div id="crumbs">
		You are at: <a href="index.php">Home</a> &gt; <a href="careers.php">Careers</a></div>
</div>
<div id="main-wrapper">
	<div id="equal-1" class="width-three">
		...
		the people to talk to. Email or call Duncan Parker
		<a href="mailto:duncan@parkwoodsolutions.com?subject=PDS Sales Opening">
		duncan@parkwoodsolutions.com</a> or 07748479527 for an initial chat without 
		commitment.</p>
		...
		send your CV to Duncan Parker,
		<a href="mailto:duncan@parkwoodsolutions.com?subject=PDS Sales Opening">
		duncan@parkwoodsolutions.com</a> or post to the following address:-</p>
