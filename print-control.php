	...
	<div id="equal-1" class="width-three">
		<div id="main-span">
			...
			<div class="right" style="width: 550px">
				...
				printers provide sufficient privacy and convenience, personal desktop 
				printers remain their preferred way for getting ideas onto paper. 
				It’s a preference that wastes money, time and resources every time 
				they hit the print key.</p>
				...
				<ul>
					...
					<li>Allocate output costs to users, departments, projects or 
					clients</li>
